            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold text-gray-800 dark:text-gray-200">Sua Empresa</span>
...
function DailyPassword() {
  ...
  React.useEffect(() => {
    ...
    const pseudoRandom = (dateNumber * 13) % 10000;
    const password = pseudoRandom.toString().padStart(4, "0");
